<x-app-layout>
    ...
    <div class="py-6 max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="bg-white rounded-lg shadow p-5">
            <form method="GET" action="{{ route('kasir.reports.index') }}" class="flex flex-wrap items-end gap-3">
                <div>
                    <label class="block text-xs font-medium text-gray-500 mb-1">Periode</label>
                    <select name="range" class="rounded-md border-gray-300 text-sm shadow-sm">
            ...
            <div class="mt-3 pt-3 border-t border-gray-100">
                <a href="{{ route('kasir.reports.export', array_filter(['range' => $range, 'date_from' => $dateFrom ?? null, 'date_to' => $dateTo ?? null])) }}"
